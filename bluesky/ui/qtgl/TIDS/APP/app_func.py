...
appmain = [['a1', 'UCO',            ['lambda: console.Console._instance.stack("EXQ CMD UCO")',
           ...
           ['b1', 'HDG',            ['lambda: console.Console._instance.stack("EXQ CMD HDG")',   # tidcmds.setcmd("HDG")
                                     'lambda: change_tid("TID_Function", "apphdg")']],
           ['b2', 'POS',            ['lambda: change_tid("TID_Function", "apppos")']],
           ...
           ['c1', 'EFL',            ['lambda: console.Console._instance.stack("EXQ CMD EFL")',  # tidcmds.setcmd("EFL")
                                     'lambda: change_tid("TID_Function", "appefl")']],
           ['c2', 'TFL',            ['lambda: change_tid("TID_Function", "apptfl")']],
           ...
           ['d1', 'SPD',            ['lambda: console.Console._instance.stack("EXQ CMD SPD")',
                                     'lambda: change_tid("TID_Function", "appspd")']],
           ['d2', 'DPL',            ['lambda: change_tid("TID_Function", "appdpl")']],
           ...
           ['f2', 'MAIN 2',         ['lambda: change_tid("TID_Function", "appmain2")']],
           ['f3', '',             None],
...
apphdg = [['a1', 'ARTIP',       ['lambda: console.Console._instance.stack("EXQ SETARG ARTIP")']],
          ...
          ['a4', 'RON',         ['lambda: console.Console._instance.stack("LNAV " + console.Console._instance.id_select + " ON")',
                                 ...
                                 'lambda: change_tid("TID_Function", "appmain")']],
          ...
          # ['b1', 'NIRSI', ['lambda: change_tid("TID_Function", "nirsi")']],
          # ['b2', 'SOKS2', ['lambda: change_tid("TID_Function", "soks2")']],
          # ['b3', 'GALIS', ['lambda: change_tid("TID_Function", "galis")']],
          # ['b4', '', None],
...
nirsi = [['a1',    'NIRSI',   ['lambda: console.Console._instance.stack("EXQ CHCMD ARR")',
         ...
         ['f1', 'COR',        ['lambda: change_tid("TID_Function", "apphdg")']],
         ['f2',    '',        None],
         ['f3',    '',        None],
         ['f4',    '',        None]]
...
appefl = [['a1', '',            None],
          ...
          ['a3', '',            None],
          ['a4', 'APP',         ['lambda: change_tid("TID_Function", "ils")']],
...
ils = [['a1', '06',      ['lambda: console.Console._instance.stack("EXQ CHCMD ILS")',
       ...
       ['f1',    'COR',     ['lambda: change_tid("TID_Function", "appefl")']],
       ['f2',    '',        None],
       ['f3',    '',        None],
       ['f4',    '',        None]]
...
apppos = [['a1', '',        None],
          ...
          ['b1', '',        None],
          ['b2', '7',       ['lambda: change_tid("TID_Function", "appmain")']],
          ['b3', '4',       ['lambda: change_tid("TID_Function", "appmain")']],
          ['b4', '1',       ['lambda: change_tid("TID_Function", "appmain")']],

          ['c1', '',        None],
          ['c2', '8',       ['lambda: change_tid("TID_Function", "appmain")']],
          ['c3', 'PLOT',    'lambda: None'],
          ['c4', '2',       ['lambda: change_tid("TID_Function", "appmain")']],

          ['d1', '',        None],
          ['d2', '9',       ['lambda: change_tid("TID_Function", "appmain")']],
          ['d3', '6',       ['lambda: change_tid("TID_Function", "appmain")']],
          ['d4', '3',       ['lambda: change_tid("TID_Function", "appmain")']],
...
appdpl = [['a1', 'FD1',         ['lambda: None']],
          ...
          ['f1', 'COR',         ['lambda: console.Console._instance.stack("EXQ COR")']],
          ['f2', 'ACC\nSECT',   ['lambda: change_tid("TID_Function", "accsect")']],
          ['f3', 'FIC\nMORE',   ['lambda: change_tid("TID_Function", "ficmore")']],
          ['f4', 'EXQ',         ['lambda: console.Console._instance.stack("EXQ EXQ")',
                                 'lambda: change_tid("TID_Function", "appmain")']]
          ]
...
appmain2 =  [['a1', 'UCO',          ['lambda: None']],
             ...
             ['f1', 'COR',          ['lambda: None']],
             ['f2', 'MAIN 1',       ['lambda: change_tid("TID_Function", "appmain")']],
             ['f3', '',             None],
             ['f4', 'EXQ',          ['lambda: None']],
             ]
...
fuco =   [['a1', '',            None],
          ...
          ['f2', '',            None],
          ['f3', '',            None],
          ['f4', 'EXQ',         ['lambda: change_tid("TID_Function", "appmain")']],
          ]
